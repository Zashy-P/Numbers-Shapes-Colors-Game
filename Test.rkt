...
(define catSkinEast (bitmap "C:/Users/zaina/OneDrive/Pictures/4669e110c981b83cf8185ba56501f27d.jpg"))
...
(define TutorialButton (drawButton "Tutorial"))
...
(define menu       
    (place-image (overlay (above (button-image startButton)
                                 (rectangle 400 60 "solid" "Royal Blue")
                                  TutorialButton
                                 (rectangle 400 60 "solid" "Royal Blue")
                                 leaderBoard) (bitmap "C:/Users/zaina/Downloads/background 2.jpg"))
...
(define initialWorld (make-world "menu" (make-Character catSkinEast (make-ChPos centerWidth centerHeight))))
...
(define Lobby (make-world "Lobby" (make-Character catSkinEast (make-ChPos centerWidth centerHeight))))
...
(define (sceneSelector world)
  (cond [(string=? (world-scene world) "menu")
                   (make-world "menu" (make-Character catSkinEast (make-ChPos centerWidth centerHeight)))]
        [(string=? (world-scene world) "Lobby")
                   (make-world "Lobby" (make-Character catSkinEast (make-ChPos centerWidth centerHeight)))]
        [else world]))
  
;test
(check-expect (sceneSelector (make-world "menu" (make-Character catSkinEast (make-ChPos centerWidth centerHeight)))) (make-world "menu" (make-Character catSkinEast (make-ChPos centerWidth centerHeight))))
